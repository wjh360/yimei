<template>
	<view class="container">
		...
		<scroll-view :scroll-y="parsedData.length > 0" style="height: 100%">
			<view class="input-section">
				...
				<u--textarea v-model="inputText" height="200rpx" maxlength="100000" placeholder="请输入需要解析的文本数据，每行一条记录"
					:autoHeight="false" :showConfirmBar="false" confirmType="换行"></u--textarea>
			...
			<view class="data-section" v-if="parsedData.length > 0">
				...
				<view class="table-container">
					...
					<view v-for="(item, index) in parsedData" :key="index" :class="[
						...
						<view class="table-cell" @tap="editField('date', index)">
							<text :class="[
								'cell-text',
						...
						<view class="table-cell shop-name-cell" @tap="editField('shopName', index)">
							<text :class="[
								'cell-text',
						...
						<view class="table-cell full-flex" @tap="editField('customer', index)">
							<text :class="[
								'cell-text',
						...
						<view class="table-cell full-flex" @tap="editField('project', index)">
							<text :class="[
								'cell-text',
						...
						<view class="table-cell full-flex" @tap="editField('operation', index)">
							<text :class="[
								'cell-text',
		...
		<u-popup :show="showEditPopup" mode="center" :round="10" closeable @close="showEditPopup = false"
